...
print(results)
# fwrite(results, paste0("AEAT/out/segovia/segovia-", sel_year, "-IDENHOGreal_estate.csv")) # nolint: commented_code_linter.
...
svytotal(~gran_tenedor, dt_sv) %>% print()
svytotal(~NPROP_ALQ, subset(dt_sv, gran_tenedor == 1)) %>% print()
