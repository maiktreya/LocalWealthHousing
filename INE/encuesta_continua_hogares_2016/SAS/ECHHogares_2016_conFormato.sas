...
Consta de las siguientes partes:			
 ...
 Entrada:                                                           			
     - Fichero SAS sin formatos: 	 ECHHogares_2016.sas7bdat		
 Salida:                                                           			
     - Fichero SAS con formatos: 	 ECHHogares_2016_conFormato.sas7bdat		
			
Donde:			
	* Operación: ECHHogares Encuesta Continua de Hogares_Hogares		
	* Periodo: 2016		
			
************************************************************************************************************************/			
			
/*1) Definir la librería de trabajo: introducir el directorio que desee como librería			
(se da como ejemplo 'C:\Mis resultados'), y copiar en ese directorio el fichero sas "ECHHogares_2016.sas7bdat"*/			
...
data ROutput.ECHHogares_2016_ConFormato;
	set ROutput.ECHHogares_2016;
...
RUN;
/* FIN PROGRAMA: Microdatos en SAS: ECHHogares_2016.sas*/
