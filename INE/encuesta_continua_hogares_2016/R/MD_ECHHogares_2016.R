...
#     2016: A�o(s) de producci�n de los datos
#
# Entrada:
#     - Dise�o de registro: 	dr_ECHHogares_2016.xlsx
...
fichero_micro <- "INE/encuesta_continua_hogares_2016/md_ECHHogares_2016.txt"
fichero_meta <- "INE/encuesta_continua_hogares_2016/dr_ECHHogares_2016.xlsx"
...
data.table::fwrite(dt, "INE/ECH.2016.gz")
